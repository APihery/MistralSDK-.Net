...
namespace MistralSDK.ChatCompletion
{
    ...
    public class MessageResponse
    {
        ...
        /// For reasoning models, returns the final answer (thinking excluded).
        /// For raw chunks, use <see cref="ContentChunks"/>.
        /// </summary>
        [JsonIgnore]
        public string Content => MessageContentExtensions.GetContentText(_contentRaw) ?? string.Empty;

        /// <summary>
        /// Gets the raw content chunks when the API returns structured content (reasoning).
        /// </summary>
        [JsonIgnore]
        public List<ContentChunk>? ContentChunks => _contentRaw as List<ContentChunk>;

        /// <summary>Raw content (string or chunks). Set when building from code; populated from JSON when deserializing.</summary>
